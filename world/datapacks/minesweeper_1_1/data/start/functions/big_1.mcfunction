say New Big_1 Game Started

#Reset variables
scoreboard players set variables initial_mines 300
...
setblock 10 109 -5 repeating_command_block{Command:"function main:50x50_300/debug",auto:1}
...
fill 0 105 0 49 105 49 repeating_command_block{Command:"execute if block ~ 108 ~ air run function mine_gen:50x50_300/start_spawn",auto:1}
