...
#highscore thingo
execute if score variables timer < variables bg2_bt run say New Best Time!
execute if score variables timer < variables bg2_bt run scoreboard players operation variables bg2_bt = variables timer