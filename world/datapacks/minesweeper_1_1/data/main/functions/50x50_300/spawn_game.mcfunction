...
fill 0 105 0 49 105 49 repeating_command_block{Command:"function main:50x50_300/game_state",auto:1}
...
setblock 8 107 -5 repeating_command_block{Command:"execute if score variables cleared matches 2200 run function main:50x50_300/win",auto:1}
